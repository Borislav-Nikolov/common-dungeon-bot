...
def add_or_update_player_data(player: Player):
    add_or_update_players_data([player])


def add_or_update_players_data(players: list[Player]):
    player_data = dict()
            ...
            PLAYER_FIELD_CHARACTERS: list(
                map(
                    lambda character: {
                        ...
                        CHARACTER_FIELD_CLASSES: character.classes,
    ...
    return Player(
        ...
        inventory=list(
            map(
                ...
                player_data[PLAYER_FIELD_INVENTORY]
            )
        )
    )
